...
const Index = () => {
  ...
  const renderView = () => {
    switch (currentView) {
      case 'submit':
        return <GrievanceForm onBack={() => setCurrentView('home')} />;
      case 'dashboard':
        return <GrievanceDashboard onBack={() => setCurrentView('home')} />;
      default:
        return (
            ...
            <section className="container mx-auto px-4 py-12 text-center">
              <div className="max-w-4xl mx-auto">
                ...
                <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
                  A safe space for couples to address concerns, find solutions, and grow stronger together through guided resolution.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <Button 
                    ...
                    variant="outline"
                    className="border-pink-300 text-pink-600 hover:bg-pink-50 px-8 py-3 rounded-full text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
                  >
                    View Dashboard
                  </Button>
                </div>
